...
import { Form, Input, Select, Divider, Switch, Upload, Steps, Space } from "antd";
  ...
  const renderUserDetailsStep = () => (
    <>
      ...
      <Form.Item name="preferred_products_services" label="Preferred Products/Services">
        <TextArea rows={3} placeholder="Enter preferred products and services" />
      </Form.Item>
  ...
  return (
    <Modal visible={visible} onClose={() => {
      ...
      <div className={styles.profileContainer}>
        ...
        >
          {currentStep === 0 ? renderUserDetailsStep() : renderPersonaDetailsStep()}
